...
-- ВРЕМЕННАЯ СЛОЖНОСТЬ --
	Сложность распаковки O(n), где n - длина запакованной строки.
	Сложность поиска наибольшего префикса O(n*Log(m)), где n - количество строк, m - длина самой короткой строки.
-- ПРОСТРАНСТВЕННАЯ СЛОЖНОСТЬ --
	O(n), где n - количество строк. Сложность одинакова для распаковки и для поиска префикса.
-- Посылка --
...
/**
*функция, возвращающая наибольший общий префикс имеющихся строк 
